		...
		<div class="wrapper-set-img"> 
			<div class="set-img"> 
				<div class="mini_set_img">
					<a href="../img/all sets/set_13/big-1.jpg" data-lightbox="test"><img src="../img/all sets/set_13/small-1.jpg" alt=""></a>
					<a href="../img/all sets/set_13/big-2.jpg" data-lightbox="test"><img src="../img/all sets/set_13/small-2.jpg" alt=""></a>
					<a href="../img/all sets/set_13/big-4.jpg" data-lightbox="test"><img src="../img/all sets/set_13/small-4.jpg" alt=""></a>
				</div>
				<div class="top-img-set">
					<img src="../img/all sets/set_13/top-img.jpg" alt="top-img">	 
				</div> 
			</div>
